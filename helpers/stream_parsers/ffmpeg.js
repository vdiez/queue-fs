module.exports = {
    ...
    parse(data) {
        ...
        if (match_progress && this.progress.duration) {
            ...
            let percentage = Math.round(this.progress.current * 100 / this.progress.duration);
        ...
        if (match_duration) this.progress.duration = Number(match_duration[3]) + Number(match_duration[2]) * 60 + Number(match_duration[1]) * 3600;
    }
};